...
function verAnuncio(titulo,id,modalidad,estado,ciudad,seccion,apartado,creado,estatus){
  ...
  if(window.innerWidth< 960){
    ...
    window.open("<?php echo base_url().'index.php/'.'misanuncios/ver/'?>"+id, '_blank');
  }
          ...
          self.setContent(`         
                  ...
                  <div class="row justify-content-center">
                    <div class="form-group col-11 col-sm-11">
                      ...
                      <textarea id='anuncio' class="form-control pulpox-validar" aria-label="With textarea" rows="10" maxlength="1000">${data.anuncio}</textarea>
    ...
    buttons: {
      ...
      guardarEdicion: {
        ...
        action: function(){
          ...
          $.post("<?php echo base_url().'index.php/'.'misanuncios/editarAnuncio/'?>", {anuncio_editado})
            .done(function(response){
              //var data = JSON.parse(response)
