  ...
  <div class="collapse navbar-collapse" id="main-menu-toggler">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <?php if (!(isset($_SESSION['usuario_id']))) { ?> 
        ...
        <li class="nav-item plpx-btn btn-pulpox-singup">
          <a class="nav-link " id='btn-pulpox-singup' href="<?php echo base_url() . 'index.php/usuario/login/'?>">Crear Cuenta</a>
        </li>
      <?php } ?> 
      </ul>
    </div>
    <?php if (isset($_SESSION['usuario_id'])) { ?> 
      <div class="dropdown" id='dropdown_menu'>
        <a  class="dropdown-toggle plpx-btn plpx-btn-info" id='boton-cuenta' role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <?php echo $_SESSION['usuario_usuario'] ?>
        </a>
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
          <a id='boton_micuenta' class="dropdown-item" href="#">Mi Cuenta</a>
          <a id='boton_salir' class="dropdown-item"  href="#">Salir</a>   
        </div>
      </div>
    <?php } ?>  
